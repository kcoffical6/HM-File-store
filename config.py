...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6189754444:AAElpqNPrqWNySUY8TKtwK9UoI5SUc0K33Q")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001877063723"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1852823985"))

#Port
PORT = os.environ.get("PORT", "8080")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://erx:erx@cluster0.8oza6qj.mongodb.net/?retryWrites=true&w=majority")
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>Kindly Please join my channel - @Kan_Serial / ದಯವಿಟ್ಟು ನನ್ನನ್ನು ಬಳಸಲು ಚಾನಲ್‌ಗೆ ಸೇರಿಕೊಳ್ಳಿ - @Kan_Serial</b>")
